...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-black py-20 pt-32 md:py-32">
      <div className="container mx-auto px-4">
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          >
            <div className="rounded-xl border border-white/10 bg-gradient-to-br from-white/5 to-white/0 p-6 md:p-8">
              <h2 className="mb-6 text-xl font-bold text-white md:text-2xl">Send us a Message</h2>
          ...
          >
            <div className="grid gap-4 sm:grid-cols-2">
              {contactInfo.map((info, index) => (
                <motion.div
                  key={index}
                  className="rounded-xl border border-white/10 bg-gradient-to-br from-white/5 to-white/0 p-5"
                  initial={{ opacity: 0, y: 30 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.6, delay: 0.3 + index * 0.1 }}
                  whileHover={{ y: -3 }}
                >
                  <div className="mb-3 inline-flex rounded-lg bg-green-500/10 p-2.5">
        ...
        <motion.div
          className="mt-8 overflow-hidden rounded-xl border border-white/10 bg-gradient-to-br from-green-500/5 to-black"
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <div className="flex h-96 items-center justify-center">
            <div className="text-center">
              <MapPin className="mx-auto mb-3 h-16 w-16 text-green-500" />
              <p className="text-lg text-gray-400">Map Integration</p>
